...
// Usar el template_key guardado en BD; si no existe, usar el primero como fallback
const activeTemplateKey = props.scheme.template_key && Object.keys(templates).includes(props.scheme.template_key)
    ? props.scheme.template_key
...
const form = useForm({
    ...
    template_key: props.scheme.template_key || activeTemplateKey,
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow-sm sm:rounded-lg border border-gray-100 p-6">
                    ...
                    <form @submit.prevent="submit" class="space-y-8">
                        ...
                        <div v-if="Object.keys(form.errors).length > 0" class="bg-red-50 border border-red-200 rounded-md p-4 mb-4">
                            <h4 class="text-red-800 font-semibold mb-2">Corrige los siguientes errores:</h4>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <el-select v-model="form.requires_product" multiple placeholder="Selecciona productos..." style="width: 100%;">
                                            <el-option label="Vida (METLIFE / PERFECTLIFE)" value="Vida" />
                        ...
                        <div v-if="activeTemplateKey === 'activity_ratio'">
                            ...
                            <div class="space-y-3 mb-8">
                                <div v-for="(eq, index) in form.pna_equivalences" :key="index" class="flex items-center gap-4 bg-gray-50 p-4 border rounded-md">
                                    ...
                                    <el-button type="danger" plain @click="removeEquivalence(index)" class="mt-2 md:mt-0">
                        ...
                        <div>
                            <div class="flex justify-between items-center border-b pb-2 mb-4 mt-8">
                                <div>
                                    <h3 class="text-lg font-medium text-gray-900">{{ activeTemplateKey === 'activity_ratio' ? '6.' : '5.' }} Matriz de Compensación</h3>
                                </div>
