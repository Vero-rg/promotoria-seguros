                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-100">
                    <div class="p-6 text-gray-900">
                        <div class="flex flex-col sm:flex-row justify-between items-center mb-6">
                            <h2 class="text-2xl font-semibold mb-4 sm:mb-0">Esquemas de Bonos</h2>
                            ...
                            <table class="w-full text-left border-collapse">
                                <thead>
                                    <tr class="border-b bg-gray-50">
                                        <th class="py-3 px-4 text-sm font-medium text-gray-600">Nombre del Bono</th>
                                ...
                                <tbody>
                                    ...
                                    <tr v-if="schemes.length === 0">
                                        <td colspan="5" class="py-8 text-center text-gray-500 text-sm">
                                            No hay esquemas de bonos registrados.
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
