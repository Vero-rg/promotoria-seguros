            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div v-if="schemes.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div 
                        ...
                        :key="scheme.id"
                        class="bg-white/80 backdrop-blur-xl rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 hover:border-emerald-200 transition-all duration-300 overflow-hidden flex flex-col"
                    >
                        <!-- Card Header -->
